...
public class TreeSetManipulation {
	...
	public static void main(String[] args) {
        ...
        // Use the subSet() method to get the elements in the set that are greater than or equal to a lower bound and less than an upper bound (A (inclusive) to C (exclusive)).
